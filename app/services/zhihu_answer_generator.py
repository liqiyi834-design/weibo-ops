...
class ZhihuAnswerGenerator:
    ...
    def generate(self, request: GenerateZhihuAnswerRequest) -> GenerateZhihuAnswerResponse:
        ...
        data = complete_json_with_retry(
            ...
            user_prompt=self._build_prompt(request, style, fact_summary, classification, retrieved, opinion),
            required_fields=[
                "question_title",
                "answer_title",
                "opening_judgement",
    ...
    def _build_prompt(self, request, style, fact_summary, classification, retrieved, opinion) -> str:
        return "\n".join(
            [
