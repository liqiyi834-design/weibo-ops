param(
    [ValidateSet("daily_hot_topics_review", "draft_generation_queue", "safety_review_digest", "auto_candidate_to_review_text", "ingest_current_research_to_rag", "style_memory_ingest", "draft_feedback_review")]
    [string]$Workflow,
